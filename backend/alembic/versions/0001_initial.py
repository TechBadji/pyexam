...
def upgrade() -> None:
    ...
    """)
    op.execute("CREATE INDEX ix_mcq_options_question_id ON mcq_options (question_id)")
    ...
    """)
    op.execute("CREATE INDEX ix_submissions_student_id ON submissions (student_id)")
    op.execute("CREATE INDEX ix_submissions_exam_id    ON submissions (exam_id)")
    op.execute("CREATE INDEX ix_submissions_token      ON submissions (submission_token)")
    ...
    """)
    op.execute("CREATE INDEX ix_answers_submission_id ON answers (submission_id)")
    op.execute("CREATE INDEX ix_answers_question_id   ON answers (question_id)")
